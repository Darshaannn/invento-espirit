...
function TestimonialCard({
  ...
  return (
    <div className="bg-white/5 p-8 border border-white/5 shadow-sm hover:shadow-md transition-shadow">
      <div className="text-4xl text-[#8B0000]/20 mb-4 font-serif" aria-hidden>
        "
      </div>
      <p className="text-sm font-medium text-white/70 mb-8 italic leading-relaxed">
        {quote}
      </p>
      <div>
...
function HeroStatic() {
  return (
    <div className="flex flex-col items-center gap-8">
      ...
      <p className="text-lg md:text-2xl text-white/60 mb-12 max-w-3xl mx-auto font-medium leading-relaxed italic">
