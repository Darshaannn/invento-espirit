        ...
        <div className="min-h-screen bg-[#0F0A1F] text-white flex flex-col font-sans selection:bg-[#9D50FF] selection:text-white relative overflow-hidden">
            ...
            <header className="flex justify-between items-center px-8 py-6 relative z-10">
                ...
                <div className="flex items-center gap-4">
                    <div className="bg-[#1A142E] px-4 py-2 border border-white/10 flex items-center gap-2 text-sm font-medium hover:border-[#9D50FF]/50 transition-colors cursor-default">
                        <Clock size={14} className="text-[#9D50FF]" />
                        00 : 30
                    </div>
                    <button className="p-2 bg-[#1A142E] hover:bg-white/10 transition-colors border border-white/5">
            ...
            <main className="flex-1 flex items-center justify-center p-6 relative z-10">
                <div className="w-full max-w-4xl bg-[#130D26]/80 backdrop-blur-xl border border-white/10 p-10 md:p-14 shadow-2xl relative">
                    ...
                    {/* Image Placeholder */}
                    <div className="w-full h-64 md:h-80 bg-[#FFE4C4] mb-12 flex items-center justify-center overflow-hidden shadow-inner relative group cursor-pointer">
                        {/* This would be the actual image. Using a placeholder pattern */}
                        <div className="absolute w-32 h-32 bg-[#E6B89C] top-1/4 left-1/3 shadow-xl" />
                        <div className="absolute w-40 h-24 bg-[#8B9582] bottom-1/4 right-1/3 shadow-xl transform rotate-3" />
                        <div className="absolute w-28 h-12 bg-[#F0F4F8] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 shadow-lg rotate-12" />
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
                        {[
                            ...
                            <button
                                ...
                                className={`p-4 border-2 text-left font-medium transition-all duration-200 flex items-center ${selectedOption === opt.id
                    ...
                    <div className="flex justify-between items-center border-t border-white/5 pt-8">
                        <button className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors text-sm font-medium px-4 py-2 hover:bg-white/5">
                            <ArrowLeft size={16} /> Previous
                        </button>

                        <div className="flex items-center gap-4">
                            <button className="text-gray-400 hover:text-white transition-colors text-sm font-medium px-4 py-2 hover:bg-white/5">
                                Skip Question
                            </button>
                            <Link href="/analysis" className="bg-[#9D50FF] text-white px-8 py-3 font-bold shadow-lg shadow-[#9D50FF]/25 hover:bg-[#8338ec] hover:scale-105 active:scale-95 transition-all">
                                Confirm Answer
                            </Link>
                        </div>
                    </div>
            ...
            <footer className="py-8 text-center relative z-10">
                ...
                <div className="flex items-center justify-center gap-2 mt-6">
                    ...
                    <div className="w-1.5 h-1.5 bg-[#9D50FF]" />
                    <div className="w-1.5 h-1.5 bg-white/20" />
                    <div className="w-1.5 h-1.5 bg-white/20" />
                </div>
            </footer>
